...
export function ValidationTable(
    ...
    function checkValidation(isSelected: any, validationName: string) {
        ...
        if (!isSelected) {
            ...
            if (Object.values(selectedItems[0][validationName]).length === 0 || selectedItems[0][validationName]["results"].length === 0) {
                ...
                <ExpandableSection header="Validation Results">
                    <SpaceBetween size="l">
                        <CodeEditor
                            ...
                            language="sql"
                            value={checkValidation(isSelected, "count_validation")}
                        ...
                        <CodeEditor
                            ...
                            editorContentHeight={70}
                            language="sql"
                            value={checkValidation(isSelected, "number_validation")}
                            preferences={undefined}
                            loading={aceLoading}
                            onPreferencesChange={({ detail }) =>
                                handleCodeEditorPreferencesChange(detail)
                        ...
                        <CodeEditor
                            ...
                            editorContentHeight={70}
                            language="sql"
                            value={checkValidation(isSelected, "string_validation")}
                            preferences={undefined}
                            loading={aceLoading}
                            onPreferencesChange={({ detail }) =>
                                handleCodeEditorPreferencesChange(detail)
